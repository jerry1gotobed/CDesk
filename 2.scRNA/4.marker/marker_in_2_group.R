...
# Filter the significant marker genes
...
if(nrow(top_genes) > 0) {
	...
	subset_data <- subset(scRNA, idents = c(opt$cell_type_1, opt$cell_type_2))  # Filter the 2 specified groups

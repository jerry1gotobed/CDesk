...
def process_sample(sample_path, sample_name,output_dir, genome,mode,start,end):
    ...
    try:
        ...
        # Run findMotifsGenome.pl（block until done）
        ...
        return f"❌ {sample_name} run fail：{e}"
    except Exception as e:
        return f"❌ {sample_name} error：{str(e)}"

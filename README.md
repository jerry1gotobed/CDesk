...
python CDesk.py bulkRNA DEG gfold -i /mnt/linzejie/CDesk_test/result/1.RNA/1.preprocess/Bam -o /mnt/linzejie/CDesk_test/result/1.RNA/3.DEGD/gfold -m /mnt/linzejie/CDesk_test/data/1.RNA/3.DEGD/meta2.xlsx -s mm10 -p -g LEUTX,POU5F1 -t 100
